...
const CREATURES: readonly CreatureDefinition[] = [
  ...
  { key: 'umbrellama-1', family: 'umbrellama', level: 1, name: 'Drizzle Umbrellama', texture: 'creature-umbrellama-1', assetPath: 'assets/characters/umbrellama-1.svg', damage: 10, attackMs: 1320, projectileColor: 0x9edbff, accentColor: 0x6bb8ff },
  { key: 'umbrellama-2', family: 'umbrellama', level: 2, name: 'Monsoon Umbrellama', texture: 'creature-umbrellama-2', assetPath: 'assets/characters/umbrellama-2.svg', damage: 24, attackMs: 1190, projectileColor: 0xc1b8ff, accentColor: 0x8c7dff },
  { key: 'umbrellama-3', family: 'umbrellama', level: 3, name: 'Tempest Umbrellama', texture: 'creature-umbrellama-3', assetPath: 'assets/characters/umbrellama-3.svg', damage: 54, attackMs: 1040, projectileColor: 0xe5d6ff, accentColor: 0xb08cff },
  { key: 'mopossum-1', family: 'mopossum', level: 1, name: 'Bucket Mopossum', texture: 'creature-mopossum-1', assetPath: 'assets/characters/mopossum-1.svg', damage: 12, attackMs: 1640, projectileColor: 0x99f0c9, accentColor: 0x7ee6b8 },
  { key: 'mopossum-2', family: 'mopossum', level: 2, name: 'Scrub Mopossum', texture: 'creature-mopossum-2', assetPath: 'assets/characters/mopossum-2.svg', damage: 29, attackMs: 1480, projectileColor: 0xb9ffd9, accentColor: 0x70d9aa },
  { key: 'mopossum-3', family: 'mopossum', level: 3, name: 'Chrome Mopossum', texture: 'creature-mopossum-3', assetPath: 'assets/characters/mopossum-3.svg', damage: 66, attackMs: 1300, projectileColor: 0xe2fff0, accentColor: 0x85e9c0 },
  { key: 'fanthom-1', family: 'fanthom', level: 1, name: 'Breeze Fanthom', texture: 'creature-fanthom-1', assetPath: 'assets/characters/fanthom-1.svg', damage: 7, attackMs: 760, projectileColor: 0xb8f5ff, accentColor: 0x9be7ff },
  { key: 'fanthom-2', family: 'fanthom', level: 2, name: 'Cyclone Fanthom', texture: 'creature-fanthom-2', assetPath: 'assets/characters/fanthom-2.svg', damage: 16, attackMs: 680, projectileColor: 0xbec7ff, accentColor: 0x7e90ff },
  { key: 'fanthom-3', family: 'fanthom', level: 3, name: 'Poltergust Fanthom', texture: 'creature-fanthom-3', assetPath: 'assets/characters/fanthom-3.svg', damage: 35, attackMs: 590, projectileColor: 0xd9d6ff, accentColor: 0x6f7cff },
  { key: 'socktopus-1', family: 'socktopus', level: 1, name: 'Laundry Socktopus', texture: 'creature-socktopus-1', assetPath: 'assets/characters/socktopus-1.svg', damage: 9, attackMs: 980, projectileColor: 0xffc0e1, accentColor: 0xff9fcf },
  { key: 'socktopus-2', family: 'socktopus', level: 2, name: 'Spin Socktopus', texture: 'creature-socktopus-2', assetPath: 'assets/characters/socktopus-2.svg', damage: 22, attackMs: 875, projectileColor: 0xffe19a, accentColor: 0xffbd76 },
  { key: 'socktopus-3', family: 'socktopus', level: 3, name: 'Royal Socktopus', texture: 'creature-socktopus-3', assetPath: 'assets/characters/socktopus-3.svg', damage: 50, attackMs: 760, projectileColor: 0xfff0ba, accentColor: 0xffd46e },
  { key: 'microwhale-1', family: 'microwhale', level: 1, name: 'Snack Microwhale', texture: 'creature-microwhale-1', assetPath: 'assets/characters/microwhale-1.svg', damage: 16, attackMs: 2050, projectileColor: 0x8ff5e2, accentColor: 0x7de2d1 },
  { key: 'microwhale-2', family: 'microwhale', level: 2, name: 'Plasma Microwhale', texture: 'creature-microwhale-2', assetPath: 'assets/characters/microwhale-2.svg', damage: 38, attackMs: 1830, projectileColor: 0xffc28f, accentColor: 0xffae72 },
  { key: 'microwhale-3', family: 'microwhale', level: 3, name: 'Supernova Microwhale', texture: 'creature-microwhale-3', assetPath: 'assets/characters/microwhale-3.svg', damage: 86, attackMs: 1600, projectileColor: 0xffe2a8, accentColor: 0xff9f66 }
];
